        ...
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <div class="display-inline-block">
                    @lang('lang.catalog_tasks') (@lang('lang.automation')) <span class="align-middle display-inline p-t-3 p-l-8"
                        data-toggle="tooltip" title="@lang('lang.catalog_tasks_info')" data-placement="top"><i class="ti-info-alt font-17"></i></span>
                </div>
                <span>
