...
@section('title', 'Contact Builtfront for Home Builder Support')

@section('content')
    <div class="container page-wrapper">
        <div class="row signup align-items-center grid md:grid-cols-2 grid-cols-1 gap-5 items-center md:px-20 px-3 py-20" id="contact-us-form">
            <div class="col-md-6">
                ...
                <div class="contact-details">
                    ...
                    <div class="">
                        We are here to help you with any questions or problems you may be experiencing. <br>
                        <h4><img src="{{ asset('public/frontend-v2/contact-us.png') }}" alt="" width="400"
                                 height="400"></h4>
                    </div>
                ...
                <div class="contact-form" id="contact-form">
                    ...
                    <form>
                        <div class="form-group row">
                            <label for="contact_name" class="col-sm-12 col-12 text-left control-label col-form-label">Name</label>
                            <div class="col-sm-12 col-md-6">
                                <input type="text" class="form-control w-full py-2 mb-3" id="contact_name" name="contact_name"
                                       value="" data-sharkid="__0">
                            </div>
                        </div>

                        <!--contact_name-->
                        <div class="form-group row">
                            <label class="col-sm-12 text-left control-label col-form-label" for="contact_email">Email</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control w-full py-2 mb-3" id="contact_email" name="contact_email"
                                       value="" data-sharkid="__1">
                            </div>
                        </div>

                        <!--contact_message-->
                        <div class="form-group row">
                            <label class="col-sm-12 text-left control-label col-form-label" for="contact_message">Message</label>
                            <div class="col-sm-12">
                                <textarea class="form-control w-full py-2 mb-3" rows="8" name="contact_message"
                                          id="contact_message" data-sharkid="__2"></textarea>
                            </div>
                        </div>
                    </form>
                    <!--form buttons-->
    ...
    <div class="hidden" id="contact-us-thank-you">
        <div class="md:px-20 flex flex-col items-center py-20">
            <div class="w-1/2">
...
<g id="Background_Complete">
    ...
    <g>
        <g>
            ...
            <h3 class="text-2xl">We will respond to you very soon.</h3>
        </div>
    </div>
...
@push('head')
    <meta name="description" content="Need help with your home building business? Contact Builtfront's expert support team. We're here to assist you.">
