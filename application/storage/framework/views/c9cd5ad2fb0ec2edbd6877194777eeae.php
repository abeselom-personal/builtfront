        ...
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <div class="display-inline-block">
                    <?php echo app('translator')->get('lang.catalog_tasks'); ?> (<?php echo app('translator')->get('lang.automation'); ?>) <span class="align-middle display-inline p-t-3 p-l-8"
                        data-toggle="tooltip" title="<?php echo app('translator')->get('lang.catalog_tasks_info'); ?>" data-placement="top"><i class="ti-info-alt font-17"></i></span>
                </div>
                <span>
...
<!--sidebar--><?php /**PATH /var/www/html/application/resources/views/pages/itemtasks/components/tasks-side-panel.blade.php ENDPATH**/ ?>