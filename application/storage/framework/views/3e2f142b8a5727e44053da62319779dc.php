...
<!--each row-->
<tr id="item_<?php echo e($item->item_id); ?>" class="<?php echo e($item->pinned_status ?? ''); ?>">
        ...
        <span class="list-table-action font-size-inherit">
            ...
            <span class="list-table-action">
                <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                    data-parent="item_<?php echo e($item->item_id); ?>" data-url="<?php echo e(url('/items/'.$item->item_id.'/pinning')); ?>"
