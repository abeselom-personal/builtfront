...
<script type="text/javascript" src="/public/js/codemirror/codemirror.min.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
<!--IMPORTANT NOTES (June 2024) - any new JS libraries added here that are booted/initiated in boot.js should also be added to the landlord footerjs.blade.js, for saas--><?php /**PATH /var/www/html/application/resources/views/layout/footerjs.blade.php ENDPATH**/ ?>