...
<script src="public/js/core/card.js?v=<?php echo e(config('system.versioning')); ?>"></script><?php /**PATH /var/www/html/application/resources/views/pages/task/modal.blade.php ENDPATH**/ ?>