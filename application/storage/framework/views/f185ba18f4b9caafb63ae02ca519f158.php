<div class="card count-<?php echo e(@count($types ?? [])); ?>" id="categories-table-wrapper"
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table id="demo-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                ...
                <tbody id="types-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.types.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
<?php /**PATH /var/www/html/application/resources/views/pages/types/components/table/table.blade.php ENDPATH**/ ?>