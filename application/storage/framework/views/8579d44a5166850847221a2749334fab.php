        ...
        <ul data-modular-id="project_tabs_menu" class="nav nav-tabs profile-tab project-top-nav list-pages-crumbs"
            ...
            <li class="nav-item">
                ...
                <a class="nav-link tabs-menu-budgets   js-dynamic-url js-ajax-ux-request" data-toggle="tab"
                    ...
                    data-loading-target="embed-content-container"
                    data-dynamic-url="<?php echo e(_url('/projects')); ?>/<?php echo e($project->project_id); ?>/budgets"
                    data-url="<?php echo e(_url('/projects')); ?>/<?php echo e($project->project_id); ?>/project-budgets"
                    href="#projects_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.budget'))); ?></a>
            </li>
            <!--[tasks]-->
...
<?php /**PATH /var/www/html/application/resources/views/pages/project/components/misc/topnav.blade.php ENDPATH**/ ?>