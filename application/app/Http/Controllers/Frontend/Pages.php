...
class Pages extends Controller {
    ...
    public function show() {
        ...
        // Custom pages
        $customPageSlugs = ['client-management', 'project-management', 'sales-management', 'team-management'];
        if(in_array($page_permanent_link, $customPageSlugs)) return view('frontend.pages.custom-pages.' . $page_permanent_link)->render();
        ...
        return view('frontend/pages/page-v2', compact('payload', 'mainmenu', 'page', 'footer', 'content'))->render();
