...
class Signup extends Controller {
    ...
    public function index() {
        ...
        return view('frontend/signup/page-v2', compact('page', 'packages', 'mainmenu', 'section'))->render();
    ...
    public function createAccount(CreateAccount $request, CreateTenantRepository $createtenantrepo) {
        ...
        $billing_cycle = 'monthly'; //request('billing_cycle'); // Update 6
        ...
        $plan_id = env('DEFAULT_PACKAGE_ID'); //str_replace(['monthly_', 'yearly_', 'free_'], '', request('plan'));  // Update 6
