...
if ( array_key_exists( 'layout_meta', $common_meta ) && $common_meta['layout_meta'] != 'default' ) {
    ...
    $post_layout = seargin_option( 'single_post_default_layout', 'right-sidebar' );
}
                    ...
                    <div class="breadcrumb__content text-<?php echo esc_attr( $banner_text_align ); ?>">
                        <h2 class="breadcrumb__title">
                            ...
                            if ( ! empty( $custom_title ) ) {
                                ...
                                $default_title = seargin_option('show_default_title', true);
                                if($default_title == true){
                                    the_title();
                                }else{
                                    $post_banner_title = seargin_option('single_post_banner_title');
                        ...
                        <?php
                        $post_breadcrumb = seargin_option('single_post_breadcrumb', false);
...
<?php endif; ?>
    ...
    <div id="primary" class="content-area pt-150 pb-150 layout-<?php echo esc_attr( $post_layout ); ?>">
