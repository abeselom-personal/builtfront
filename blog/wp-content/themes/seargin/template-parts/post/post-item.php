<?php
if(is_archive()){
	$post_item_layout = seargin_option('archive_layout', 'right-sidebar');
}else if(is_search()){
	$post_item_layout = seargin_option('search_layout', 'right-sidebar');
}else{
	$post_item_layout = seargin_option('blog_layout', 'right-sidebar');
}
...
$show_author_name = seargin_option('post_author', true);
$show_post_date = seargin_option('post_date', true);
$show_category = seargin_option('show_category', false);
$show_read_more = seargin_option('read_more_button', true);
?>
		...
		<div class="post-content-wrapper">
			...
			<?php if ( 'post' === get_post_type() ) : ?>
				<ul class="post-meta ul_li">
					...
					<li><?php seargin_post_first_category(); ?></li>
					<?php endif; ?>
				</ul>
			<?php endif; ?>
			...
			<div class="post-excerpt">
				<p><?php echo seargin_words_limit( get_the_excerpt(), $word_count ); ?><?php if ( ! empty( get_the_content() ) ) {
						echo ' [...]';
					} ?></p>
			</div>
			...
			<div class="post-read-more">
                <?php if($post_item_layout == 'left-sidebar' || $post_item_layout == 'right-sidebar') : ?>
                    <a class="xb-btn" href="<?php echo esc_url( get_the_permalink() ) ?>">
		                <?php echo esc_html__( 'Read More', 'seargin' ); ?>
                    </a>
                <?php else : ?>
                    <a class="xb-btn" href="<?php echo esc_url( get_the_permalink() ) ?>">
		                <?php echo esc_html__( 'Read More', 'seargin' ); ?>
