<?php
if(is_archive()){
	$page_layout = seargin_option('archive_layout', 'right-sidebar');
}else if(is_search()){
	$page_layout = seargin_option('search_layout', 'right-sidebar');
}else{
	$page_layout = seargin_option('blog_layout', 'right-sidebar');
}
