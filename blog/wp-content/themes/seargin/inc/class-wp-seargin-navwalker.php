<?php
/**
 *seargin Bootstrap Navwalker
 *
 * @packageseargin-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Seargin_Bootstrap_Navwalker' ) ) {
	/**
	 * Seargin_Bootstrap_Navwalker class.
	 */
	class Seargin_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'seargin' ) . '">' . esc_html__( 'Add a menu', 'seargin' ) . '</a></li>';
			$fallback_output .= '</ul>';
