...
if (array_key_exists('layout_meta', $common_meta) && $common_meta['layout_meta'] != 'default') {
    ...
    $page_layout = seargin_option('page_default_layout', 'full-width');
}
...
?>
    ...
    <div id="primary" class="content-area page-content-area pt-150 pb-150 layout-<?php echo esc_attr($page_layout); ?>">
        <div class="container">
            <div class="row">
