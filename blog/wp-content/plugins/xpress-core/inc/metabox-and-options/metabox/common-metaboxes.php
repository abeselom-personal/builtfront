<?php
$seargin_common_meta = 'seargin_common_meta';

// Create a metabox
CSF::createMetabox($seargin_common_meta, array(
...
CSF::createSection($seargin_common_meta, array(
...
CSF::createSection($seargin_common_meta, array(
	...
	'fields' => array(
        ...
        array(
            'id'       => 'meta_header_type',
            'type'     => 'switcher',
            'title'    => __( 'Header Style', 'seargin-plugin' ),
            'text_on'  => __( 'Yes', 'seargin-plugin' ),
            'text_off' => __( 'No', 'seargin-plugin' ),
            'default'  => false
        ),
        array(
            ...
            'type'        => 'select',
            'chosen'      => true,
            'title'       => __('Select Header Style', 'seargin-plugin' ),
            'options'     => Seargin_Plugin_Helper::get_header_types(),
            'dependency' => array( 'meta_header_type', '==', 'true' ),
        ),
        array(
            'id'       => 'page_header_disable',
            'type'     => 'switcher',
            'title'    => __( 'DIsable This page Header?', 'seargin-plugin' ),
            'text_on'  => __( 'Yes', 'seargin-plugin' ),
            'text_off' => __( 'No', 'seargin-plugin' ),
            'default'  => false
        ),
...
CSF::createSection( $seargin_common_meta, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'output' => array( 'background' => 'body', 'background-color' => '.seargin-main-wrap' )
        ),
        array(
            'id'     => 'preloader-color',
            'type'   => 'color',
            'title'  => 'Preloader Color',
            'output' => array( 'border-color' => '#xb-loadding .loading-spin::before')
        ),
        array(
            'id'     => 'preloader-bg-color',
            'type'   => 'color',
            'title'  => 'Preloader BG Color',
            'output'      => '#xb-loadding',
