...
$seargin_theme_option = 'seargin_theme_options';

// Create options
CSF::createOptions( $seargin_theme_option, array(
    'framework_title' => wp_kses(
        sprintf(__("Seargin Options <small>V %s</small>", 'xpress core'), $seargin_core_data->get('Version')),
        array('small' => array())
    ),
	'menu_title'      => __('Theme Options','xpress-core'),
	'menu_slug'       => 'seargin-options',
    'enqueue_webfont'    => true,
    'show_in_customizer' => true,
    'menu_icon' => 'dashicons-category',
	'show_sub_menu'   => false,
	'class'           => 'seargin-theme-option',
	'menu_position'   =>3,
	'footer_text'   => wp_kses(
 ...
 * Career options
 */
require_once 'career-options.php';
