...
class Seargin_CTA_V3 extends Widget_Base
{
    ...
    {
        return esc_html__('CTA V3', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'button_two_option',
            [
                'label' => esc_html__('Button Two', 'xpress-core'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-btn.btn-white' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-btn.btn-white' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-btn.btn-white:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-btn.btn-white:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render()
    {
        ...
        <div class="bc-cta__wrap bg_img" <?php if (!empty($settings['bg_image']['url'])): ?>
             style="background-image: url('<?php echo esc_url($settings['bg_image']['url']); ?>') <?php endif; ?>">
            <div class="sec-title sec-title--md sec-title--business mb-25">
                <?php if (!empty($settings['title'])): ?>
                    <h2 class="title text-50 mb-30"><?php echo wp_kses($settings['title'], true); ?></h2>
                <?php endif; ?>
            ...
            <div class="bc-cta__btn">
                <?php if (!empty($settings['btn_label'])): ?>
                    <a class="xb-btn xb-btn--business btn-black hover-white"
                ...
                <?php if (!empty($settings['btn_label2'])): ?>
                    <a class="xb-btn xb-btn--business btn-white hover-black"
                       href="<?php echo esc_url($settings['btn_link2']['url']); ?>">
                        <div class="btn-anim-wrap">
                            <span class="button-text"><?php echo esc_html($settings['btn_label2']); ?></span>
                            <span class="button-text"><?php echo esc_html($settings['btn_label2']); ?></span>
                        </div>
                    </a>
                <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new Seargin_CTA_V3());