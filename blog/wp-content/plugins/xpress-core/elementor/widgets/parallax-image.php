...
class Seargin_Parallax_Image extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <div class="parallax-image">
            <img data-parallax='{<?php if(!empty($settings['posX'])) { ?> "x":<?php echo esc_attr($settings['posX']) ?>, <?php } if(!empty($settings['posY'])) { ?> "y":<?php echo esc_attr($settings['posY']) ?> <?php } ?> }' src="<?php echo esc_url($settings['parallax_img']['url']); ?>" alt="">
        </div>
...
Plugin::instance()->widgets_manager->register(new Seargin_Parallax_Image());