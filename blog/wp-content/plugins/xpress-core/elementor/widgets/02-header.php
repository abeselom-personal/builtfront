...
class Seargin_Header_Two extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <header id="xb-header-area" class="site-header header-business <?php if ($sticky_header_enable == true): ?> is-sticky <?php endif; ?>">
                    ...
                    <div class="ul_li_between">
                        ...
                        if(!empty($settings['btn_text'])):
                            ...
                            <div class="xb-header__btn d-none d-lg-block">
                                <a class="xb-btn xb-btn--business btn-dark" href="<?php echo esc_url($settings['btn_link']['url']); ?>">
                        ...
                        <div class="xb-hamburger-menu">
                            <div class="xb-nav-mobile">
                                <div class="xb-nav-mobile-button btn-white"><i class="fal fa-bars"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register(new Seargin_Header_Two());