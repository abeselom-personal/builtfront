...
class Seargin_Header_Six extends Widget_Base
{
    ...
    {
        return esc_html__('Header Six', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'number_title', [
                'label' => esc_html__('Number Title', 'xpress-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ad-header-top .number' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ad-header-top .number'
            ]
        );
        $this->add_control(
            'social_style',
    ...
    protected function render()
    {
        ...
        <header id="xb-header-area"
                class="site-header header-advisor <?php if ($sticky_header_enable == true): ?> is-sticky <?php endif; ?>">
            <?php if ($settings['topbar_enable'] == 'yes'): ?>
                <div class="container">
                    <div class="ad-header-top ul_li_between">
                        <span class="number mt-10"><?php echo esc_html($settings['number_title']); ?> <span><?php echo esc_html($settings['number']); ?></span></span>
                        <div class="xb-social ul_li mt-10">
                ...
                <div class="container">
                    <div class="ul_li_between">
                        ...
                        <div class="xb-header__btn d-none d-lg-block">
                            <a class="xb-btn xb-btn--advisor" href="<?php echo esc_url($settings['btn_link']['url']); ?>"><?php echo esc_html($settings['btn_text']); ?></a>
                        </div>
                        <?php endif; ?>
...
Plugin::instance()->widgets_manager->register(new Seargin_Header_Six());