...
class Seargin_Feature extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'features',
            [
                'label' => esc_html__('Add Feature Item', 'xpress-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .xb-feature2 .xb-item--icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            foreach ($settings['features'] as $feature):
                ...
                <div class="xb-feature xb-feature2 mt-70">
                    ...
                    <?php if (!empty($feature['title'])): ?>
                        <h3 class="xb-item--title"><?php echo esc_html($feature['title']); ?></h3>
                    <?php endif; ?>
                    <?php if (!empty($feature['content'])): ?>
                        <p class="xb-item--content"><?php echo wp_kses($feature['content'], true); ?></p>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
        </div>
...
Plugin::instance()->widgets_manager->register(new Seargin_Feature());