...
class Seargin_Contact_V4 extends Widget_Base
{
    ...
    {
        return esc_html__('Contact V4', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'subtitle_icon', [
                'label' => esc_html__('Subtitle Icon', 'xpress-core'),
        ...
        $this->start_controls_section(
            'image_option',
            [
                'label' => esc_html__('Image Option', 'xpress-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ad-contact' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ad-contact' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
    ...
    protected function render()
    {
        ...
        <div class="ad-contact pos-rel">
            <div class="sec-title sec-title--advisor mb-30">
                <?php if (!empty($settings['sub_title'])): ?>
                    <span class="subtitle ul_li"><?php echo wp_get_attachment_image($settings['subtitle_icon']['id'], 'thumbnail'); ?> <?php echo esc_html($settings['sub_title']); ?></span>
                <?php endif;
            ...
            <div class="row">
                <div class="col-lg-7">
                    <?php if (!empty($settings['shortcode'])): ?>
                        <div class="ins-contact-form advisor-contact-form">
...
Plugin::instance()->widgets_manager->register(new Seargin_Contact_V4());