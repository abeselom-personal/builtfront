...
class Seargin_Header_Five extends Widget_Base
{
    ...
    {
        return esc_html__('Header Five', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-insurance .xb-header__info li' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-insurance .xb-header__info li'
            ]
        );
        $this->add_control(
            'lang_style',
    ...
    protected function render()
    {
        ...
        <header id="xb-header-area"
                class="site-header header-insurance <?php if ($sticky_header_enable == true): ?> is-sticky <?php endif; ?>">
            <?php if ($settings['topbar_enable'] == 'yes'): ?>
                <div class="xb-header__top">
                    <div class="container mxw_1775">
                        <div class="ul_li_between">
                            <ul class="xb-header__info ul_li">
                                <?php
                            ...
                            <ul class="xb-header__info ul_li ml-auto">
                                <li>
                                    <span><?php \Elementor\Icons_Manager::render_icon($settings['number_icon'], ['aria-hidden' => 'true']); ?></span><?php echo esc_html($settings['number']); ?>
                                </li>
                            </ul>
                        ...
                        <div class="xb-header__right ul_li">
                            <ul class="xb-header__action ul_li">
                                ...
                                <?php if ($settings['offcanvas_enable'] == 'yes'): ?>
                                    <li><a class="offcanvas-sidebar-btn"
                                           href="javascript:void(0);"><?php \Elementor\Icons_Manager::render_icon($settings['offcanvas_icon'], ['aria-hidden' => 'true']); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                            <?php if ($settings['button_enable'] == 'yes'): ?>
                                <div class="xb-header__btn ml-70">
                                    <a class="xb-btn xb-btn--insurance btn-dark" href="<?php echo esc_url($settings['btn_link']['url']); ?>"><?php echo esc_html($settings['btn_text']); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="header-bar d-lg-none">
                            <a class="xb-nav-mobile xb-nav-mobile" href="javascript:void(0);"><img
                                        src="<?php echo get_template_directory_uri(); ?>/assets/img/menu-bar.svg"
                                        alt=""></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="header-search-form-wrapper style-insurance">
            <?php seargin_heder_search(); ?>
        </div>

        <div class="offcanvas-sidebar header-insurance">
...
Plugin::instance()->widgets_manager->register(new Seargin_Header_Five());