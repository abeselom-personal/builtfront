...
class Seargin_Header_Four extends Widget_Base
{
    ...
    {
        return esc_html__('Header Four', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'bar_color',
            [
                'label' => esc_html__('Bar Styel', 'xpress-core'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'bar_bg_color',
            [
                'label' => esc_html__('Bar BG Color', 'xpress-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-header-bar' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'bar_line_color',
            [
                'label' => esc_html__('Bar Line Color', 'xpress-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-header-bar span' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        ?>
        <header id="xb-header-area" class="site-header header-law is-sticky">
            <div class="xb-header__wrap xb-header">
                <div class="container">
                        ...
                        <div class="xb-header__right ul_li">
                            <?php if (!empty($settings['btn_text'])): ?>
                                <div class="xb-header__btn d-none d-lg-block">
                                    <a class="xb-btn xb-btn--law btn-dark"
                            ...
                            <?php if ($settings['offcanvas_enable'] == 'yes'): ?>
                                <div class="d-none d-lg-block">
                                    <a class="xb-header-bar offcanvas-sidebar-btn ml-10" href="javascript:void(0);">
        ...
        <div class="offcanvas-sidebar law-sidebar">
...
Plugin::instance()->widgets_manager->register(new Seargin_Header_Four());