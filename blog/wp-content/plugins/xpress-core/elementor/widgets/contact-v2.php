...
class Seargin_Contact_V2 extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .lw-contact__inner' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .lw-contact__inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .lw-contact-form .xb-item--field input' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .lw-contact-form .xb-item--field textarea' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .lw-contact-form .xb-item--field input' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .lw-contact-form .xb-item--field textarea' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .lw-contact-form .xb-item--field .nice-select' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .lw-contact-form .xb-item--field input, 
                                {{WRAPPER}} .lw-contact-form .xb-item--field textarea,
                                {{WRAPPER}} .lw-contact-form .xb-item--field select',
            ]
        );
    ...
    protected function render()
    {
        ...
        <section class="contact br-20 pos-rel pt-150 pb-150">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6">
                        <div class="lw-contact__inner">
                            <div class="sec-title sec-title--law mb-45">
                            ...
                            <?php if (!empty($settings['shortcode'])): ?>
                                <div class="ins-contact-form lw-contact-form">
                    ...
                    <div class="col-xl-6">
                        <div class="ins-location-map">
                            ...
                            <div class="ins-location-inner style-law">
                                <?php
                                $i = 0;
...
Plugin::instance()->widgets_manager->register(new Seargin_Contact_V2());