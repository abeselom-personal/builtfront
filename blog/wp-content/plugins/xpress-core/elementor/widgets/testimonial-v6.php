...
class Seargin_Testimonial_V6 extends Widget_Base
{
    ...
    {
        return esc_html__('Testimonial V6', 'xpress-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'testimonial_setting',
            [
                'label' => esc_html__('Dot Setting', 'xpress-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'show_dot',
            [
                'label' => esc_html__('Show Dot', 'xpress-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ad-testimonial .xb-item--avatar::before' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ad-testimonial .xb-item--content' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ad-testimonial .xb-item--content',
            ]
        );
        $this->add_control(
            'name_hr',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ad-testimonial .xb-item--name' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ad-testimonial .xb-item--name',
            ]
        );
        $this->add_control(
            'desig_hr',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ad-testimonial .xb-item--desig' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ad-testimonial .xb-item--desig',
            ]
        );
        $this->add_control(
            'dot_hr',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ad-testimonial-slider .swiper-pagination .swiper-pagination-bullet' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render()
    {
        ...
        <div class="ad-testimonial__inner">
            <div class="ad-testimonial-slider swiper-container">
                <div class="swiper-wrapper">
                    <?php
                    foreach ($settings['testimonials'] as $testimonial):
                        ?>
                        <div class="swiper-slide">
                            <div class="ad-testimonial ul_li">
...
Plugin::instance()->widgets_manager->register(new Seargin_Testimonial_V6());