...
class Seargin_FAQ extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .xb-accordion .block .acc-btn' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-accordion .block' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .xb-accordion .block .acc-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .xb-accordion .block .acc-btn',
            ]
        );
        $this->add_control(
            'arr_hr',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-accordion .block .acc-btn .arrow::before' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .xb-accordion .block .acc-btn .arrow' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
...
Plugin::instance()->widgets_manager->register(new Seargin_FAQ());