...
class Seargin_Video extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <div class="xb__video pos-rel">
            <?php echo wp_get_attachment_image($settings['image']['id'], 'full'); ?>
            <?php if (!empty($settings['video_url'])): ?>
                <a class="btn-video popup-video btn-video-center" href="<?php echo esc_url($settings['video_url']); ?>"><i
...
Plugin::instance()->widgets_manager->register(new Seargin_Video());